...
export default function BibliotecaDigital() {
    ...
    /**
     * Engine de busca real-time por String Matching correndo no lado cliente O(n).
     * Decisão arquitetural de TCC: Como o array em memória é pequeno (limitado a 6 simulados no reducer state local), 
     * processar o state nativo do React é inofensivo. Para uma base de milhares, transferiria o esforço 
     * pro Service-side (Node) via query params GET na listagem paginada da API REST (limit / offset).
     */
